...
<body>
	...
	<main class="myPage">
		<div class="delete-container">
			...
			<form
				action="<%=request.getContextPath()%>/home/deleteAccount.jsp"
				method="post" class="delete-form" name="withForm">
				<label for="password">비밀번호</label> <input type="password"
					id="password" name="pwd" required placeholder="비밀번호 입력" /> 
					<input type="button" value="회원탈퇴" class="submit-btn"  onclick="pwdCheck();"/>
			</form>
		</div>
	</main>
	<hr>
	...
	<script src="<%=request.getContextPath()%>/home/js/withdraw.js?status=1"></script>
</body>
