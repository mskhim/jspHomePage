 ...
 * Generated at: 2024-12-15 23:56:40 UTC
...
public final class boardContentModifyPage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (cvo==null&&cvo.getId().equals(request.getParameter("id"))) {//세션이 없고, 세션아이디와 글 아이디가 맞지않으면 접근불가
	...
	return;
      ...
      out.write("	href=\"");
      out.print(request.getContextPath());
      out.write("/home/css/boardWritePage.css\" />\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	<header>\r\n");
  ...
  if(cvo2==null){
      ...
      out.write("    <form method=\"post\" action=\"/jspHomePage/boardModifyServlet.do\" class=\"boardForm\">\r\n");
