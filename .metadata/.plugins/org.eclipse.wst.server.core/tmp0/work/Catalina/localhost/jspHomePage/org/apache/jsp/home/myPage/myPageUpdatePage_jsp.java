 ...
 * Generated at: 2024-12-19 07:33:51 UTC
...
public final class myPageUpdatePage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/home/headerNavSection.jsp", Long.valueOf(1734589649715L));
...
String address2 = cvo.getAddress2();
  ...
  if(cvo2==null){
      ...
      out.write("		<form action=\"/jspHomePage/customerUpdate.do\" method=\"post\"\r\n");
      out.write("			id=\"div-main\" class=\"myForm\" name=\"regForm\">\r\n");
      out.write("			<div class=\"title-table\">사이트 이용정보 수정</div>\r\n");
      out.write("			<table>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td class=\"col-key\">아이디</td>\r\n");
      out.write("					<td><input id=\"input-id\" type=\"text\" name=\"id\" value=\"");
      out.print(id);
      out.write("\"\r\n");
      out.write("						required readonly=\"readonly\" /><span></span></td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td class=\"col-key\">비밀번호</td>\r\n");
      out.write("					<td><input id=\"input-pw1\" type=\"password\"\r\n");
      out.write("						title=\"비밀번호는 영문자와 숫자 6~10자리입니다\" name=\"pwd\" value=\"");
      out.print(pwd);
      out.write("\"\r\n");
      ...
      out.write("					<td><input id=\"input-pw2\" type=\"password\" name=\"\"\r\n");
      out.write("						value=\"");
      out.print(pwd);
      out.write("\" required /><span></span></td>\r\n");
      out.write("				</tr>\r\n");
      ...
      out.write("					<td><input id=\"input-name\" type=\"text\" name=\"name\"\r\n");
      out.write("						value=\"");
      out.print(name);
      out.write("\" required /><span></span></td>\r\n");
      out.write("				</tr>\r\n");
      ...
      out.write("					<td>공백없이 한글,영문,숫자만 입력 가능(4글자 이상)<br />닉네임을 바꾸시면 앞으로 1일 이내에는\r\n");
      out.write("						변경 할 수 없습니다.<br /> <input id=\"input-nickname\" type=\"text\"\r\n");
      ...
      out.write("					<td><input id=\"input-email\" type=\"email\" name=\"email\"\r\n");
      out.write("						value=\"");
      out.print(email);
      out.write("\" required /><span></span></td>\r\n");
      out.write("				</tr>\r\n");
      ...
      out.write("					<td><input type=\"radio\" name=\"joinRoute\" value=\"\" />인터넷검색 <input\r\n");
      out.write("						type=\"radio\" name=\"joinRoute\" value=\"\" />배너광고 <input type=\"radio\"\r\n");
      out.write("						name=\"joinRoute\" value=\"\" />관련기사를 보고 <input type=\"radio\"\r\n");
      out.write("						name=\"joinRoute\" value=\"\" />미라지 홈페이지 보고 <input type=\"radio\"\r\n");
      out.write("						name=\"joinRoute\" value=\"\" />주변사람 소개 <input type=\"radio\"\r\n");
      out.write("						name=\"joinRoute\" value=\"\" />기타</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<td class=\"col-key\">전화번호</td>\r\n");
      out.write("					<td><input id=\"input-tel\" type=\"tel\" name=\"tel\"\r\n");
      out.write("						value=\"");
      out.print(tel);
      out.write("\" required /><span></span></td>\r\n");
      out.write("				</tr>\r\n");
      ...
      out.write("					<td><input id=\"input-mobile\" type=\"tel\" name=\"phone\"\r\n");
      out.write("						value=\"");
      out.print(phone);
      out.write("\" required /><span></span></td>\r\n");
      out.write("				</tr>\r\n");
      ...
      out.write("					<td id=\"input-address\"><input type=\"text\" id=\"zipcode\"\r\n");
      out.write("						value=\"");
      out.print(zipcode);
      out.write("\" name=\"zipCode\" size=\"4px\" required /><span></span>\r\n");
      out.write("						<input id=\"btn-searchAddr\" type=\"button\" value=\"주소 검색\"\r\n");
      out.write("						onClick=\"zipCheck()\" /><br /> <input type=\"text\" id=\"addr1\"\r\n");
      out.write("						value=\"");
      out.print(address1);
      out.write("\" size=\"35px\" required readonly=\"readonly\"\r\n");
      out.write("						name=\"address1\" /> 기본주소<br /> <input type=\"text\"\r\n");
      out.write("						id=\"addr2\" value=\"\" size=\"35px\" name=\"address2\"\r\n");
      out.write("						value=\"");
      out.print(address2);
      out.write("\" /> 상세주소<br /> <input type=\"text\" name=\"\"\r\n");
      out.write("						value=\"\" size=\"35px\" name=\"address3\" /> 참고항목</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</table>\r\n");
      out.write("\r\n");
      out.write("			<div id=\"btns-submit\">\r\n");
      out.write("				<input id=\"btn-join\" type=\"submit\" value=\"정보수정\" /> <input\r\n");
      out.write("					id=\"btn-cancel\" type=\"button\" value=\"취소\"\r\n");
