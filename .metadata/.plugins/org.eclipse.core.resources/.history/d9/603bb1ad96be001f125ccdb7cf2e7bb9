...
%>	
alert("<%=msg%>"); 
window.location.replace("<%=request.getContextPath()%>/home/loginPopup.jsp");
<%
}
	...
	<div class="loginSection">
		<article class="loginInput">
			<form method="post"
				...
				<!-- 상태유지 -->
				<div class="maint">
					<input type="checkbox" name="maint" class="maint" <%=(!MyUtility.isNullOrEmpty(cid))?"checked":"" %>> <label
