...
<%@ include file="/home/carouselSection.jsp"%>
    ...
    <main class="registPage">
       <h4>정  보  수  정</h4>
    <form action="customerUpdate.jsp" method="post" id="div-main" class="myForm" name="regForm">
      ...
      <table>
        ...
        <tr>
          ...
          <td id="input-address">
            ...
            />
            기본주소<br />
            <input type="text" id="addr2" value="" size="35px" name="address2" value="<%=address2%>" />
            상세주소<br />
      ...
      <div id="btns-submit">
        <input id="btn-join" type="submit" value="정보수정" />
        <input
          id="btn-cancel"
          type="button"
          value="취소"
